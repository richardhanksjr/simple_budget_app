...
// Format 2 decimal places on the new expense input as typing happens
// $('.new-expense-input').on('keyup', function(){
//     let numNoDecimal = $('.new-expense-input').val().toString().replace('.', '');
//     let stringNoLeadingZeros = numNoDecimal;
//     // Because of the nature of what we are doing here (removing the first element from the string),
//     // we are not incrementing the forloop counter.
